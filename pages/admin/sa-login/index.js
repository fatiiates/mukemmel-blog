...
<body>
	...
	<form action="islem.php" class="login-form" method="POST">
        ...
        <input type="text" class="login-username" autofocus="true" required="true" placeholder="Email" name="admin_userID" />
        <input type="password" class="login-password" required="true" placeholder="Password" name="admin_pass" />
